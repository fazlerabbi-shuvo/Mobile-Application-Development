...
class DentistDetails extends StatelessWidget {
  const DentistDetails({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final heart = ModalRoute.of(context)!.settings.arguments as ModelDen;
    return Scaffold(
      body: Column(
        children: [
          Expanded(
