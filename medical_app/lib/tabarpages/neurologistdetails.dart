...
class NeurologistDetails extends StatelessWidget {
  const NeurologistDetails({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final heart = ModalRoute.of(context)!.settings.arguments as ModelNeu;
    return Scaffold(
      body: Column(
        children: [
          Expanded(
