...
class PsychologistDetails extends StatelessWidget {
  const PsychologistDetails({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final heart = ModalRoute.of(context)!.settings.arguments as ModelPsy;
    return Scaffold(
      body: Column(
        children: [
          Expanded(
